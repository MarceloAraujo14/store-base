...
public class ProductResource {
    ...
    @CrossOrigin(origins = "*")
    @GetMapping("/product")
    public ResponseEntity findProductsByName(@RequestParam("name") String name){
    ...
    public ResponseEntity<Page<Product>> findProductsByNameContains(@RequestParam("name") String name){
    ...
    public ResponseEntity<Page<Product>> findProductsByPage(@PathVariable("page") Pageable page){
        log.info("findAllByPage - page: {}", page);
        return ResponseEntity.ok(findAllPageable.process(page));
    }
